...
- broaden actor-owned projections beyond focused-agent routing and warmed session/list snapshots so prompt state, transcript pages, and provider/read models can be served without compatibility-store reads on the hot path
