...
- Landed: workflow prompt start/completion/cancellation entrypoints are now isolated behind the app workflow-runtime boundary, so prompt lifecycle callers no longer invoke scheduler runtime progression functions directly.
