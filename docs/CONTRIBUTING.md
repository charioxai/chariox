...
- Treat `apps/cli` as the primary local CLI surface. New local-client feature work should target the TypeScript client unless the daemon contract itself is under investigation.
