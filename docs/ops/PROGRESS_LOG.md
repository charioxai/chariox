...
- Expand actor-owned projections beyond focused-agent routing and warmed session/list/history snapshots so prompt state and provider/read models no longer require synchronous compatibility-store access.
