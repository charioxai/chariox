...
- Broaden `WorkspaceCoordinator` claim enforcement to provider prompt lifecycles, workflow node dispatch, file-level scopes, and port claims before parallel relay/workflow scale-out.
