...
- Expand actor-owned projections beyond focused-agent routing and warmed session/list snapshots so prompt state, transcript pages, and provider/read models no longer require synchronous compatibility-store access.
