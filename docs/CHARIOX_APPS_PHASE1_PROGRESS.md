...
Status of the open Apps Phase 1 PR stack. Nothing below is merged yet: the OSS stack is #433 → #434 → #435 → #436 → #438 → #439 → #441 → #442 → #443 → #444 → #445 → #446 → #447 → #455 → #456 → #457 → #458 → #459 → #460 → #461 → #462 → #463. Side PRs are #430, #431, #437, #440, #448, #452. Web work is in chariox-cloud #218 → #220 → #221 → #222.
...
|---|---|---|---|---|
| P1.01 | Partial | protocol 345–355 across the stack | Shape tests for every new request and response | Records for App sets, file metadata and the inbox |
