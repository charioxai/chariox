...
| P1.13 | Implemented | #441, #462, #463, Cloud #224, #225 | Live create and edit of documents, versions. Import: Documents asks for files, the owner chooses them in the web terminal's trusted prompt. Export: a document is offered and saved from the web prompt | The live App-side import needs the runtime re-enrolled with the new SDK |
