...
- Latest verified batch: Codex turn settlement tracking moved into `provider/codex_runtime/turn.rs`; input and transcript projection remain in sibling modules.
