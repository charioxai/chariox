...
- Latest verified batch: client pairing, machine, and relay shell commands moved into `packages/kernel-client/src/shell-remote-command.ts`; `shell-executor.ts` is down to 2,655 lines.
