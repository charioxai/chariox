...
- Latest verified batch: shared workflow protocol request builders moved into `packages/kernel-client/src/ipc-workflow-requests.ts`, with `ipc-requests.ts` retained as a compatibility barrel.
