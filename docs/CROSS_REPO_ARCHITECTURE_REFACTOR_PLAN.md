...
- Latest verified batch: Cloud WEB_CLI/C2 historical docs moved under `docs/archive/`; active Cloud refactor guidance now points at browser-relay-kernel boundaries.
