...
- Latest verified batch: BrowserKernelClient relay bootstrap/transport responsibilities are extracted; feature-owned workspace, waiting-room, freeform, and responsive stylesheet modules replaced six numbered style buckets; full web tests pass.
