...
- Latest verified batch: workspace local-daemon wire contracts moved into `local/api/types/workspace.rs`; `types.rs` remains the protocol compatibility barrel.
