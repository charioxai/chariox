...
- Latest verified batch: workspace link shell commands moved into `packages/kernel-client/src/shell-workspace-command.ts`; `shell-executor.ts` is down to 2,458 lines.
