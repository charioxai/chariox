...
- Latest verified batch: remote machine, pairing, and relay output formatting moved into `packages/kernel-client/src/shell-remote-format.ts`; `shell-executor.ts` is down to 3,199 lines.
