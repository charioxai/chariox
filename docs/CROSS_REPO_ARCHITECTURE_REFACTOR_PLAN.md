...
- Latest verified batch: BrowserKernelClient relay bootstrap, socket lifecycle, frame routing, response/event handling, reconnect recovery, subscription lifecycle/sending, and control request sending are extracted; full web tests pass.
