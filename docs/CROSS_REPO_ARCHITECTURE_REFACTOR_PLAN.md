...
- Latest verified batch: provider runtime slot ownership/restore/clear helpers moved into `provider/run_actor/runtime_slots.rs`; `provider/run_actor.rs` is down to 1,398 lines.
