...
- Latest verified batch: CLI slice daemon calls moved into `apps/cli/src/slice-api.ts`, IPC response variant decoding moved into `ipc-response.ts`, and the native endpoint bridge type gate was unblocked.
