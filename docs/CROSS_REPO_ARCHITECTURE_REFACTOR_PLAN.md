...
- Latest verified batch: workflow list/run/publication/watchdog output formatting moved into `packages/kernel-client/src/shell-workflow-format.ts`; `shell-executor.ts` is down to 3,083 lines.
