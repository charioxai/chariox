...
- Latest verified batch: BrowserKernelClient relay bootstrap, subscriptions, socket connector, response handling, and event replay handling are extracted; full web tests pass.
