...
- Latest verified batch: Cloud API domain contracts export through `index.ts`; BrowserKernelClient subscription indexing/persistence is extracted; API focused tests and full web tests pass.
