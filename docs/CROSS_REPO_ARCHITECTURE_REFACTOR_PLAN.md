...
- Latest verified batch: CLI Cloud session invite/member helpers and workspace-link IPC helpers moved into responsibility modules; CLI lint/build/tests pass.
