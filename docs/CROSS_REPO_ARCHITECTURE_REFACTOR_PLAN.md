...
- Latest verified batch: BrowserKernelClient relay bootstrap/transport responsibilities are extracted; numbered active stylesheet buckets are replaced with feature-owned modules, including merged workflow/sidebar CSS split points; full web tests pass.
