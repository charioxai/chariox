...
- Latest verified batch: BrowserKernelClient transport, browser kernel request builders, and CLI hosted Cloud link/open lifecycle are responsibility-owned modules; Cloud web and CLI tests pass.
