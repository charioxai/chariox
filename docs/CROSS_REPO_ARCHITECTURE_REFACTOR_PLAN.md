...
- Latest verified batch: Cloud shell control-plane commands moved into `packages/kernel-client/src/shell-cloud-command.ts`; `shell-executor.ts` is down to 1,947 lines.
