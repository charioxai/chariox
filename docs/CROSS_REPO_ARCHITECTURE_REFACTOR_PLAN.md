...
- Latest verified batch: shared workspace/git/worktree/file protocol request builders moved into `packages/kernel-client/src/ipc-workspace-requests.ts`, with `ipc-requests.ts` retained as a compatibility barrel.
