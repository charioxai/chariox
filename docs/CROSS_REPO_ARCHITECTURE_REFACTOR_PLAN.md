...
- Latest verified batch: Cloud API route and service-layer modules now import domain contracts directly instead of the compatibility barrel; API build and focused API tests pass.
