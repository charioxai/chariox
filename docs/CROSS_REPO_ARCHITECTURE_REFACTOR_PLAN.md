...
- Latest verified batch: provider-run liveness/reconciliation moved into `app/provider_liveness.rs`, with session membership reads in `app/provider_run_read.rs`; `provider_runtime.rs` is 1,381 lines.
