...
- Latest verified batch: history search and semantic-search shell commands moved into `packages/kernel-client/src/shell-history-command.ts`; `shell-executor.ts` is down to 2,550 lines.
