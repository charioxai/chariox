...
- Latest verified batch: workflow graph node/edge/endpoint commands moved into `packages/kernel-client/src/shell-workflow-graph-command.ts`; `shell-executor.ts` is down to 512 lines.
