...
- Latest verified batch: Cloud API route, service-layer, and HTTP/support modules now import domain contracts directly instead of the compatibility barrel; API build and focused API tests pass.
