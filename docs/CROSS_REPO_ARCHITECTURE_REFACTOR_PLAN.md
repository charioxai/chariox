...
- Latest verified batch: kernel remote prompt relay dispatch/completion/cancellation/queue advancement lives in `app/kernel_agent/prompt_commands/remote.rs`; `prompt_commands.rs` is 951 lines.
