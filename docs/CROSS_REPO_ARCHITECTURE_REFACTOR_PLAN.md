...
- Latest verified batch: workflow publication commands moved into `packages/kernel-client/src/shell-workflow-publication-command.ts`; `shell-executor.ts` is down to 688 lines.
