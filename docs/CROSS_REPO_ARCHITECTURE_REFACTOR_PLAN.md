...
- Latest verified batch: BrowserKernelClient relay bootstrap, subscriptions, socket connector, response/event handling, reconnect recovery, and subscription sending are extracted; full web tests pass.
