...
- Latest verified batch: Codex notification projection and external-turn backfill moved into `provider/codex_runtime/events.rs`; `codex_runtime.rs` is 1,835 lines.
