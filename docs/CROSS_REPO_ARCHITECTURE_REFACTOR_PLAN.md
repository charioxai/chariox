...
- Latest verified batch: workspace, agent-utility, remote-access, and cloud-relay local-daemon wire contracts moved into domain modules under `local/api/types/`; `types.rs` remains the protocol compatibility barrel.
