...
- Latest verified batch: workflow publication gateway package generation moved into `packages/kernel-client/src/shell-workflow-publication-export.ts`; `shell-executor.ts` is down to 3,339 lines.
