...
- Latest verified batch: kernel remote prompt relay dispatch/completion/queue advancement moved into `app/kernel_agent/prompt_commands/remote.rs`; `prompt_commands.rs` is 998 lines.
