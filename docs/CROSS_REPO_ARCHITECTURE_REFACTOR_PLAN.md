...
- Latest verified batch: BrowserKernelClient relay bootstrap, subscriptions, socket connector, response/event handling, and reconnect recovery are extracted; full web tests pass.
