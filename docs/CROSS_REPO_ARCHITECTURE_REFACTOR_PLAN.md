...
- Latest verified batch: shared kernel lifecycle/health and session/user config/credential request builders moved into focused modules; `packages/kernel-client/src/ipc-requests.ts` is now a compatibility barrel.
