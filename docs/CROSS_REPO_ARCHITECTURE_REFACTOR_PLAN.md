...
- Latest verified batch: BrowserKernelClient relay bootstrap, subscriptions, socket connector, response/event handling, reconnect recovery, subscription sending, and control request sending are extracted; full web tests pass.
