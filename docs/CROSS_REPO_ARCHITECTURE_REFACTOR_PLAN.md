...
- Latest verified batch: BrowserKernelClient relay bootstrap, subscription lifecycle, socket lifecycle, response/event handling, reconnect recovery, subscription sending, and control request sending are extracted; full web tests pass.
