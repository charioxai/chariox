...
- Latest verified batch: CLI launch options, external URL opening, and prompt submission response ownership moved out of `index.tsx`; CLI lint/build/tests pass.
