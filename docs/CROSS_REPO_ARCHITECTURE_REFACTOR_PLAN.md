...
- Latest verified batch: BrowserKernelClient relay bootstrap, subscription directory, and WebSocket connector responsibilities are extracted; full web tests pass.
