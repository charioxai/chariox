...
- Latest verified batch: CLI relay status/configuration, Cloud relay login/token, and terminal pairing helpers moved into `apps/cli/src/relay-api.ts`; CLI lint/build/tests pass.
