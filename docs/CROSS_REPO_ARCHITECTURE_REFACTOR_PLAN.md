...
- Latest verified batch: OSS projection config and remote relay inventory stores extracted from `runtime/projection.rs` while preserving `runtime::projection` imports.
