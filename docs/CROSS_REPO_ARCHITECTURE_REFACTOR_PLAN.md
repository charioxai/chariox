...
- Latest verified batch: app-owned prompt activity, provider tracking, workflow-design replay, and remote-kernel selection moved out of `app.rs`; `app.rs` is 1,694 lines.
