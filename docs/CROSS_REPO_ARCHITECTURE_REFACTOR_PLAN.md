...
- Latest verified batch: config and credential shell command execution moved into `packages/kernel-client/src/shell-config-command.ts`; `shell-executor.ts` is down to 2,812 lines.
