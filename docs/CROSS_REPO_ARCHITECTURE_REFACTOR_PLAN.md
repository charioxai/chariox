...
- Latest verified batch: agent, config, provider, and workspace output formatting moved into focused kernel-client formatter modules; `shell-executor.ts` is down to 2,940 lines.
