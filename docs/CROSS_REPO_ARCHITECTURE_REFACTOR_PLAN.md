...
- Latest verified batch: shell attachment resolution moved into `packages/kernel-client/src/shell-session-attachment.ts`; `shell-executor.ts` is down to 2,267 lines.
