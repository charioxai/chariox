...
- Latest verified batch: BrowserKernelClient transport is extracted, active stylesheet buckets are feature-owned, and active Cloud/CLI naming now uses browser terminal terms outside intentional legacy storage/archive references; Cloud API and CLI tests pass.
