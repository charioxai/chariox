...
- Latest verified batch: provider auth/process shell commands moved into `packages/kernel-client/src/shell-provider-command.ts`; `shell-executor.ts` is down to 2,600 lines.
