...
- Latest verified batch: Codex prompt turn start/abort and turn-id extraction moved into `provider/codex_runtime/prompt.rs`; `codex_runtime.rs` is 1,523 lines.
