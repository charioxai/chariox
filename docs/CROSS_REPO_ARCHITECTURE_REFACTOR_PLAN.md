...
- Latest verified batch: prompt submission, wait, and reply projection moved into `packages/kernel-client/src/shell-prompt-command.ts`; `shell-executor.ts` is down to 1,324 lines.
