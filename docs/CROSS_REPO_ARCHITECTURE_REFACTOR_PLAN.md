...
- Latest verified batch: workflow watchdog and queue automation moved into `packages/kernel-client/src/shell-workflow-automation-command.ts`; `shell-executor.ts` is down to 412 lines.
