...
- Latest verified batch: prompt reply and history rendering moved into `packages/kernel-client/src/shell-history-format.ts`; `shell-executor.ts` is down to 3,257 lines.
