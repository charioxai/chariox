...
- Latest verified batch: Codex endpoint readiness and thread lifecycle binding moved into `provider/codex_runtime/lifecycle.rs`; `codex_runtime.rs` is 1,605 lines.
