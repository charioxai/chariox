...
- Latest verified batch: workflow command coordination moved into `packages/kernel-client/src/shell-workflow-command.ts`; `shell-executor.ts` is down to 164 lines.
