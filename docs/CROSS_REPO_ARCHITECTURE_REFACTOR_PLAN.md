...
- Latest verified batch: Codex client MCP config override mapping moved into `provider/codex_client/mcp_config.rs`; permission policy remains in `permission.rs`.
