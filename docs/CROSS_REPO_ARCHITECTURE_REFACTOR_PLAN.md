...
- Latest verified batch: session and Cloud collaboration output formatting moved into `packages/kernel-client/src/shell-session-format.ts`; `shell-executor.ts` is down to 3,027 lines.
