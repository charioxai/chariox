...
- Latest verified batch: Cloud API internals now import domain contracts directly; only the public compatibility export remains; API build and focused API tests pass.
