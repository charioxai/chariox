...
- Latest verified batch: dev-stub, managed dev-stub, invalid-PTY test adapter, and dev-stub drill scripts moved into `provider/registry/dev_stub_adapter.rs`; `provider/registry.rs` is down to 245 lines.
