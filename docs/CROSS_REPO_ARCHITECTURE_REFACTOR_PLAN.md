...
- Latest verified batch: agent lifecycle/config/substitute commands moved into `packages/kernel-client/src/shell-agent-command.ts`; `shell-executor.ts` is down to 972 lines.
