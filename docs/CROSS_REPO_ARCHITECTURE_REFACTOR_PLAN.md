...
- Latest verified batch: MCP/skill capability output formatting moved into `packages/kernel-client/src/shell-capability-format.ts`; `shell-executor.ts` is down to 3,151 lines.
