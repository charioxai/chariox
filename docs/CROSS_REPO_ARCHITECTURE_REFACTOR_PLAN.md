...
- Latest verified batch: CLI launch option, endpoint, workspace-target, external URL, and prompt response ownership moved out of `index.tsx`; CLI lint/build/tests pass.
