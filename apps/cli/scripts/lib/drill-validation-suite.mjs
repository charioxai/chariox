...
export const SHARED_DRILL_TEST_PATHS = Object.freeze([
  "apps/cli/scripts/deterministic-runtime-chaos-drill.test.mjs",
  ...
  "apps/cli/scripts/drill-focused-runtime-gate.test.mjs",
  ...
  "apps/cli/scripts/lib/drill-chaos-contract-registry-parity.test.mjs",
  "apps/cli/scripts/lib/drill-chaos-contract.test.mjs",
  "apps/cli/scripts/lib/drill-child-process.test.mjs",
  "apps/cli/scripts/lib/drill-cli-args.test.mjs",
  "apps/cli/scripts/lib/drill-deterministic-chaos.test.mjs",
  ...
  "apps/cli/scripts/lib/drill-focused-runtime-gate-report.test.mjs",
  ...
  "apps/cli/scripts/lib/drill-runtime-convergence-invariants.test.mjs",
  ...
  "apps/cli/scripts/lib/hosted-cloud-kernel-scenarios.test.mjs",
  "apps/cli/scripts/lib/live-claude-provider-drill-history.test.mjs",
  "apps/cli/scripts/lib/live-cloud-publication-deployment-drill-transport.test.mjs",
  "apps/cli/scripts/lib/live-external-provider-live-parity-evidence.test.mjs",
  "apps/cli/scripts/lib/live-external-provider-live-parity-observers.test.mjs",
  "apps/cli/scripts/lib/live-external-provider-live-parity-process.test.mjs",
  ...
  "apps/cli/scripts/lib/live-workflow-publication-drill-browser.test.mjs",
  "apps/cli/scripts/lib/live-workflow-publication-drill-runtime.test.mjs",
  "apps/cli/scripts/lib/live-workflow-publication-drill-session-builders.test.mjs",
  "apps/cli/scripts/lib/live-workflow-publication-drill-waiters.test.mjs",
  ...
  "apps/cli/scripts/live-reconnect-storm-drill.test.mjs",
  "apps/cli/scripts/live-relay-freeform-multi-user-drill.test.mjs",
  ...
  "apps/cli/scripts/live-terminal-stream-soak.test.mjs",
...
export const DRILL_VALIDATION_COVERAGE_AREAS = Object.freeze([
  ...
  {
    id: "runtime-fixtures",
    description: "Reusable deterministic chaos, runtime, provider, environment, time, and history-outline helpers.",
    testPaths: Object.freeze([
      "apps/cli/scripts/deterministic-runtime-chaos-drill.test.mjs",
      "apps/cli/scripts/lib/drill-chaos-contract.test.mjs",
      "apps/cli/scripts/lib/drill-cli-args.test.mjs",
...
function normalizeValidationSuitePresetContract(preset, index) {
  ...
  return {
    ...
    requiredArtifactGeneratedEvidenceRepos: sortedArtifactEvidenceRepoArray(preset.requiredArtifactGeneratedEvidenceRepos, `${preset.name}.requiredArtifactGeneratedEvidenceRepos`),
