...
test("gates required artifact kinds and evidence repos from artifact index metadata", async () => {
  ...
  try {
    ...
    assert.deepEqual(pass.requiredArtifactGeneratedEvidenceRepos, ["oss"])
    assert.deepEqual(pass.missingArtifactGeneratedEvidenceRepos, [])
    ...
    const fail = await artifactValidationGateCheck({
      ...
      requiredArtifactGeneratedEvidenceRepos: ["cloud"],
      ...
      requiredArtifactGeneratedValidationSuiteArtifactIndexes: ["/tmp/generated-suite/missing-artifacts.json"],
    ...
    assert.deepEqual(fail.missingArtifactGeneratedEvidenceRepos, ["cloud"])
    ...
    assert.deepEqual(fail.missingArtifactGeneratedValidationSuiteArtifactIndexes, ["/tmp/generated-suite/missing-artifacts.json"])
    ...
    assert.match(fail.error, /missing required artifact generated evidence repos: cloud/)
    ...
    assert.match(fail.error, /missing required artifact generated validation-suite artifact indexes: \/tmp\/generated-suite\/missing-artifacts\.json/)
...
test("gates required artifact diagnostic dimensions from artifact index metadata", async () => {
  ...
  try {
    ...
    assert.deepEqual(pass.missingArtifactRuntimeAuthorityInvariants, [])
    ...
    assert.deepEqual(fail.missingArtifactRuntimeAuthorityInvariants, ["worker-execution-authority"])
    ...
    assert.match(fail.error, /missing required artifact runtime authority invariants: worker-execution-authority/)
