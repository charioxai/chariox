  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "runtime-fixtures", testCount: 12 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=74 coverage=distributed-observability:4/)
  } finally {
