  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "runtime-fixtures", testCount: 22 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=88 coverage=distributed-observability:5/)
  } finally {
