  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "matrix-validation", testCount: 36 },
        { id: "runtime-fixtures", testCount: 21 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=87 coverage=distributed-observability:5/)
  } finally {
