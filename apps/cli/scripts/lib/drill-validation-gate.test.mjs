  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "artifact-contracts", testCount: 17 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=57 coverage=distributed-observability:1/)
  } finally {
