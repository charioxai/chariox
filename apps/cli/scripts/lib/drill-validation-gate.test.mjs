  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "matrix-validation", testCount: 23 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=48 coverage=distributed-observability:1/)
  } finally {
