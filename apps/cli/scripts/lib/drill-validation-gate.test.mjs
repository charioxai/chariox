  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "matrix-validation", testCount: 18 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=42 coverage=artifact-contracts:11/)
  } finally {
