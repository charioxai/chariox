  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "artifact-contracts", testCount: 18 },
        { id: "failure-diagnostics", testCount: 3 },
        { id: "matrix-validation", testCount: 26 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=58 coverage=distributed-observability:1/)
  } finally {
