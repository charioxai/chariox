  ...
  try {
    ...
    assert.deepEqual(report.checks.platformBundle.validationSuite, {
      ...
      coverageAreas: [
        ...
        { id: "artifact-contracts", testCount: 14 },
    ...
    assert.match(formatDrillValidationGateSummary(report), /platform_validation_suite_tests=54 coverage=distributed-observability:1/)
  } finally {
