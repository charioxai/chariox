...
test("builds validation suite artifact metadata from manifest and run report", () => {
  ...
  assert.deepEqual(drillValidationSuiteArtifactMetadata(manifest), {
    ...
    validationPresets: "distributed-runtime,distributed-state-health,native-provider-tui,remote-agent-runtime,remote-home-extension,runtime-authority,slice-runtime,workspace-live-sync",
  ...
  assert.equal(drillValidationSuiteArtifactMetadata(failureClassificationOnlyManifest).runtimeSignals, undefined)
  assert.throws(() => drillValidationSuiteArtifactMetadata({
    ...failureClassificationOnlyManifest,
    failureTaxonomyManifest: {
...
test("normalizes validation suite preset contracts", () => {
  assert.deepEqual(normalizeValidationSuitePresetContracts([{
    ...
    requiredRuntimeAuthorityInvariants: ["home-session-authority", "shared-runtime-primitives", "home-session-authority"],
    ...
    requiredRuntimeAuthorityInvariants: ["home-session-authority", "shared-runtime-primitives"],
  ...
  assert.throws(() => normalizeValidationSuitePresetContracts([{
    name: "bad-runtime-authority-invariant",
    description: "bad runtime authority invariant",
    requiredRuntimeAuthorityInvariants: ["home-session-authroity"],
  }]), /requiredRuntimeAuthorityInvariants\[0\] has unknown runtime authority invariant "home-session-authroity"/)
  assert.throws(() => normalizeValidationSuitePresetContracts([{
  ...
  assert.throws(() => normalizeValidationSuitePresetContracts([{
    name: "bad-artifact-generated-suite-artifact-index",
    description: "bad artifact generated suite artifact index",
    requiredArtifactGeneratedValidationSuiteArtifactIndexes: ["/tmp/Bearer abcdefghijklmnop.json"],
