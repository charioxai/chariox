...
export async function runRoomOfficeWork(input) {
  ...
  // Downloads is an existing default upload root; Documents is deliberately
  // outside that allowlist. Do not widen file access just for this drill.
  const document = `/home/slice/Downloads/office-${randomUUID()}.txt`
  ...
  try {
    ...
    await command(["mkdir", "-p", "/home/slice/Downloads"])
