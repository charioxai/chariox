...
test("describes stable validation gate presets", () => {
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["distributed-runtime"] })[0],
    {
      ...
      requiredArtifactGeneratedMatrixNames: ["browser-terminal-resilience-matrix", "cloud-slice-runtime-matrix", "native-provider-tui-matrix", "remote-agent-runtime-matrix", "remote-home-extension-matrix", "runtime-resilience-chaos-matrix", "slice-runtime-matrix", "workspace-live-sync-matrix"],
      ...
      requiredArtifactRuntimeSignals: ["agent-lifecycle", "client-projection-health", "home-extension-manifest-sync", "lease-health", "permission-interaction", "provider-run-lifecycle", "relay-target-freshness", "runtime-projection-health", "runtime-transition-audit", "session-authority", "slice-auth-state", "slice-runtime-state", "workspace-live-sync-state"],
      ...
      requiredRuntimeSignals: ["agent-lifecycle", "client-projection-health", "home-extension-manifest-sync", "lease-health", "permission-interaction", "provider-run-lifecycle", "relay-target-freshness", "runtime-projection-health", "runtime-transition-audit", "session-authority", "slice-auth-state", "slice-runtime-state", "workspace-live-sync-state"],
      ...
      requiredMatrices: ["browser-terminal-resilience-matrix", "cloud-slice-runtime-matrix", "native-provider-tui-matrix", "remote-agent-runtime-matrix", "remote-home-extension-matrix", "runtime-resilience-chaos-matrix", "slice-runtime-matrix", "workspace-live-sync-matrix"],
      requiredMatrixClassifications: ["cloud-runtime", "docker-runtime", "kernel-authority", "provider-auth", "provider-error", "relay-runtime", "relay-target-freshness", "remote-extension-sync", "slice-auth", "slice-runtime", "ui-client-projection", "worker-execution", "workspace-live-sync-conflict"],
      ...
      requiredScenarios: ["agent-reuse", "collab-remote-agent", "hetzner-collab", "hetzner-collaborator-reconnect-authority", "hetzner-collab-remote-agent", "hetzner-single", "hetzner-single-user-remote-agent", "hosted-browser-relay-kernel-reconnect", "hosted-cloud-relay-second-kernel-reconnect", "hosted-collab-remote-agent", "hosted-single-user-remote-agent", "lease-reconnect", "local-browser-relay-kernel-reconnect", "local-collab", "local-kernel-restart-durable-state", "local-kernel-websocket-drop", "local-managed-codex", "local-native-tui", "local-relay-restart-reconnect", "local-single", "local-tracked-codex", "local-tui-web-terminal-parity", "permission-visibility", "provider-auth", "provider-run-binding", "remote-managed-codex", "remote-native-tui", "remote-prompt-dispatch", "remote-tracked-codex", "same-host-remote-worker-restart", "session-start", "single-user-remote-agent", "slice-lifecycle", "slice-native-tui", "transcript-parity", "ui-projection", "worker-provider-resume-codex", "worker-provider-resume-opencode"],
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["distributed-state-health"] })[0],
    {
      ...
      requiredArtifactIncompleteExitCriterionStatuses: [],
      requiredRuntimeSignals: ["home-extension-manifest-sync", "lease-health", "provider-run-lifecycle", "relay-target-freshness", "runtime-projection-health", "runtime-transition-audit", "slice-auth-state", "slice-runtime-state", "workspace-live-sync-state"],
      ...
      requiredMatrices: ["browser-terminal-resilience-matrix", "cloud-slice-runtime-matrix", "remote-agent-runtime-matrix", "remote-home-extension-matrix", "runtime-resilience-chaos-matrix", "slice-runtime-matrix", "workspace-live-sync-matrix"],
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["workspace-live-sync"] })[0],
    {
      ...
      requiredArtifactExitCriterionStatuses: [],
      requiredArtifactIncompleteExitCriterionStatuses: [],
      requiredRuntimeSignals: ["relay-target-freshness", "runtime-transition-audit", "session-authority", "workspace-live-sync-state"],
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["slice-runtime"] })[0],
    {
      ...
      requiredArtifactExitCriterionStatuses: [],
      requiredArtifactIncompleteExitCriterionStatuses: [],
      requiredRuntimeSignals: ["agent-lifecycle", "client-projection-health", "provider-run-lifecycle", "runtime-projection-health", "runtime-transition-audit", "session-authority", "slice-auth-state", "slice-runtime-state"],
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["native-provider-tui"] })[0],
    {
      ...
      requiredArtifactExitCriterionStatuses: [],
      requiredArtifactIncompleteExitCriterionStatuses: [],
      requiredRuntimeSignals: ["client-projection-health", "permission-interaction", "provider-run-lifecycle", "runtime-projection-health", "runtime-transition-audit", "session-authority"],
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["runtime-authority"] })[0],
    {
      ...
      requiredArtifactExitCriterionStatuses: [],
      requiredArtifactIncompleteExitCriterionStatuses: [],
      requiredRuntimeSignals: ["agent-lifecycle", "client-projection-health", "lease-health", "permission-interaction", "provider-run-lifecycle", "runtime-projection-health", "runtime-transition-audit", "session-authority"],
      requiredRuntimeSignalOwners: ["kernel-authority", "provider-runtime", "ui-client"],
      requiredRuntimeAuthorityInvariants: [],
  ...
  assert.deepEqual(
    describeDrillValidationGatePresets({ names: ["remote-agent-runtime"] })[0],
    {
      ...
      requiredArtifactExitCriterionStatuses: [],
      requiredArtifactIncompleteExitCriterionStatuses: [],
      requiredRuntimeSignals: ["agent-lifecycle", "client-projection-health", "lease-health", "provider-run-lifecycle", "relay-target-freshness", "runtime-projection-health", "runtime-transition-audit", "session-authority"],
...
test("expands validation gate preset requirements", () => {
  assert.deepEqual(expandValidationGatePresetRequirements({
    ...
    requiredArtifactExitCriterionStatuses: [],
    requiredArtifactIncompleteExitCriterionStatuses: [],
    requiredRuntimeSignals: ["home-extension-manifest-sync", "lease-health", "provider-run-lifecycle", "runtime-transition-audit", "session-authority"],
