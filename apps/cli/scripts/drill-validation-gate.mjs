...
function printHelp() {
  console.log([
    ...
    "                         Fail when artifact index metadata lacks each generated matrix name; repeatable",
    "  --require-artifact-generated-matrix-repo REPO[,REPO]",
    "                         Fail when artifact index metadata lacks each generated matrix repo; repeatable",
    ...
    "  --require-artifact-validation-preset NAME[,NAME]",
    "                         Fail when artifact index metadata lacks each validation preset label; repeatable",
    "  --require-artifact-runtime-authority-invariant ID[,ID]",
    "                         Fail when artifact index metadata lacks each runtime authority invariant; repeatable",
  ...
  "  --require-artifact-failure-classification KIND[,KIND]",
  "                         Fail when artifact index metadata lacks each failure classification; repeatable",
  "  --require-artifact-planned-owner OWNER[,OWNER]",
    "                         Fail when artifact index metadata lacks each planned next-action owner; repeatable",
    "  --require-artifact-planned-classification KIND[,KIND]",
    "                         Fail when artifact index metadata lacks each planned next-action classification; repeatable",
