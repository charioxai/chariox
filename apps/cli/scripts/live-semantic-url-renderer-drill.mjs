...
async function main() {
  ...
  try {
    ...
    const publicationResult = await runShell(`workflow trigger create $workflow $endpoint semantic-render --route /render/* --method GET --parser-json '${parserJson}' --input-schema-json '${inputSchemaJson}' --mode async`)
