...
function printHelp() {
  console.log([
    ...
    "  --require-artifact-generated-validation-suite-artifact-index PATH",
    "                         Require aggregate artifact metadata for generated validation-suite artifact indexes",
    "  --require-artifact-generated-validation-suite-failure-root ROOT",
    "                         Require aggregate artifact metadata for generated validation-suite failure roots",
