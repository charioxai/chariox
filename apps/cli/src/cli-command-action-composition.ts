...
export function createCliCommandActionComposition(deps: CliCommandActionCompositionDeps) {
  ...
  return createCommandActionHandlers({
    ...
    grantAgentMcp: (agentRef, name, source) => grantAgentMcp(client, pendingWorkspaceTarget(), agentRef, name, source),
    revokeAgentMcp: (agentRef, name, source) => revokeAgentMcp(client, agentRef, name, source),
    ...
    grantAgentSkill: (agentRef, name, source) => grantAgentSkill(client, pendingWorkspaceTarget(), agentRef, name, source),
    revokeAgentSkill: (agentRef, name, source) => revokeAgentSkill(client, agentRef, name, source),
    ...
    grantAgentScript: (agentRef, name, environment, source) => grantAgentScript(client, pendingWorkspaceTarget(), agentRef, name, environment, source),
    revokeAgentScript: (agentRef, name, source) => revokeAgentScript(client, agentRef, name, source),
    ...
    grantAgentConnector: (agentRef, name, credential, maxSafety, source) => grantAgentConnector(client, pendingWorkspaceTarget(), agentRef, name, credential, maxSafety, source),
    revokeAgentConnector: (agentRef, name, source) => revokeAgentConnector(client, agentRef, name, source),
    listAgentExtensionCatalog: (agentRef, source) => listAgentExtensionCatalog(client, agentRef, source),
