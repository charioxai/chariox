...
function printUsage() {
  process.stdout.write([
    ...
    "  /workspace sync ...   show workspace live sync status, targets, conflicts, and ignore rules",
    ...
    "  /config workspace-live-sync managed|tracked|unrestricted set global workspace live sync",
