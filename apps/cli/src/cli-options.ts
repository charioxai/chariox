...
function printUsage() {
  process.stdout.write([
    ...
    "  /agent spawn [a] [m] [--meta] [--dir d] [--worktree d --branch b] [--machine r|--kernel k|--slice off|new|s] [--slice-display headless|headed] spawn a local, remote, slice, or meta agent",
