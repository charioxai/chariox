...
function printUsage() {
  process.stdout.write([
    ...
    "  /cloud invite create [n] create a cloud-backed collaboration invite",
    ...
    "  /relay invite create [n] create a same-relay collaboration invite",
    ...
    "  /collab invite create [n] create a collaboration invite using the configured backend",
