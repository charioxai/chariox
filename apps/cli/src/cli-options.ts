...
function printUsage() {
  process.stdout.write([
    ...
    "  /kernel remote-runtime show provider runs, remote agents, slices, home-proxy, and live sync readiness",
    ...
    "  /slice auth import    copy host provider auth into this slice account",
    "  /slice auth remove    remove a provider account from this slice",
    "  /slice auth login     start login for a slice-specific provider account",
    "  /slice auth alias     set or clear a slice provider account alias",
