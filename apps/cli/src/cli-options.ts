...
function printUsage() {
  process.stdout.write([
    ...
    "  /slice auth import    copy host provider auth into a slice",
    "  /slice auth remove    remove provider auth from a slice",
    "  /slice auth login     start provider login inside a slice",
