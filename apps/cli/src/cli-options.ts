...
function printUsage() {
  process.stdout.write([
    ...
    "  /session status       show owner, placement, live sync, extensions, and blockers",
    ...
    "  /extension catalog    list home and worker extension catalogs for an agent",
    "  /extension grant      grant an extension from home or worker to an agent",
    "  /extension revoke     revoke a home or worker extension from an agent",
    "  /extension grants     show source, runtime placement, and kernel for grants",
    "  /extension sync-status show home-proxy and worker-local sync and recovery for an agent",
    "  /extension sync-retry retry home-proxy manifest projection after worker reconnect",
    "  /extension audit      show home extension audit events and denials for an agent",
    "  /kernel health        show runtime health, remote readiness, and invariants",
    "  /kernel remote-runtime show home authority, worker runs, slices, home-proxy tools, and live sync readiness",
    ...
    "  /cloud deployments credentials list|show|setup|retry|enrollment|test|rotate|revoke|purge|bind|unbind manage destination credentials",
