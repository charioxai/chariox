  ...
  },
  {
    ...
    children: [
      ...
      { id: "workflow-add-node-all", label: "add node all", description: "Add every session agent that is not already a workflow node", value: "/workflow add node all" },
      {
        id: "workflow-queue",
        label: "queue",
        description: "Inspect and manage queued workflow launches",
        value: "/workflow queue ",
        children: [
          { id: "workflow-queue-list", label: "list", description: "List queued workflow launches", value: "/workflow queue" },
          { id: "workflow-queue-flush", label: "flush", description: "Clear the queued workflow launches", value: "/workflow queue flush" },
          { id: "workflow-queue-remove", label: "remove", description: "Remove one queued workflow launch", value: "/workflow queue remove " },
        ],
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "config-unset", label: "unset", description: "Unset a dotted config key", value: "/config unset " },
      {
        ...
        label: "managed-io",
        description: "Set the global managed I/O policy",
        value: "/config managed-io ",
        children: [
          {
            id: "config-managed-io-unrestricted",
            label: "unrestricted",
            description: "Disable managed I/O for supported provider runs",
            value: "/config managed-io unrestricted",
          },
          {
            id: "config-managed-io-required",
            label: "required",
            description: "Require managed I/O for supported provider runs",
            value: "/config managed-io required",
          },
        ],
      },
    ],
