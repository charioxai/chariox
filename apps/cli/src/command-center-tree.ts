...
export const COMMAND_TREE: CommandNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "agent-variant", label: "variant", description: "Set or clear the focused or named agent variant", value: "/agent variant " },
      {
        ...
        value: "/agent list",
        searchAliases: ["where agents run", "agent placement", "session agents", "home kernel", "worktree", "live sync", "provider run"],
      },
      {
        id: "agent-inspect",
        label: "inspect",
        description: "Show agent placement, grants, and sync state",
        value: "/agent inspect ",
        searchAliases: ["where does this run", "where agent runs", "agent placement", "agent worktree", "agent slice", "agent extensions", "home proxy grants", "home-proxy grants", "provider run", "live sync scope"],
      },
      { id: "agent-cycle", label: "cycle", description: "Cycle to next agent", value: "/agent cycle" },
      {
        id: "agent-task",
        label: "task",
        description: "View or control the focused agent's Meta mode task",
        value: "/agent task ",
        searchAliases: ["meta mode task", "metaagent task", "planner task", "pause meta mode", "abort meta mode"],
        children: [
          { id: "agent-task-show", label: "show", description: "Show the Meta mode task and plan", value: "/agent task show " },
          { id: "agent-task-edit", label: "edit", description: "Edit the Meta mode task prompt", value: "/agent task edit " },
          { id: "agent-task-plan", label: "plan", description: "Edit the Meta mode plan document", value: "/agent task plan " },
          { id: "agent-task-pause", label: "pause", description: "Pause the Meta mode task", value: "/agent task pause " },
          { id: "agent-task-resume", label: "resume", description: "Resume a paused Meta mode task", value: "/agent task resume " },
          { id: "agent-task-abort", label: "abort", description: "Abort the Meta mode task", value: "/agent task abort " },
        ],
      },
      {
        id: "agent-substitute",
  ...
  },
  {
    ...
    value: "/kernel ",
    children: [
      { id: "kernel-health", label: "health", description: "Show runtime health, remote readiness, and invariants", value: "/kernel health" },
      {
  ...
  },
  {
    ...
    children: [
      { id: "machine-list", label: "list", description: "List remote machines visible through the relay", value: "/machine list" },
      {
        id: "machine-kernels",
        label: "kernels",
        description: "List live kernels and worker readiness for a machine",
        value: "/machine kernels ",
        searchAliases: ["worker readiness", "remote readiness", "provider cli missing", "provider account missing", "remote kernel", "which worker"],
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "slice-status", label: "status", description: "Show a slice", value: "/slice status " },
      {
        id: "slice-doctor",
        label: "doctor",
        description: "Check slice worker, display, scope, operation, and provider account health",
        value: "/slice doctor ",
        searchAliases: ["slice readiness", "slice provider auth", "slice account", "slice placement", "slice auth missing", "auth missing", "provider account missing", "provider login missing"],
      },
      ...
      { id: "slice-state", label: "state", description: "Show saved slice state and restart requirements", value: "/slice state ", searchAliases: ["slice state", "slice snapshot", "saved slice state", "slice restart requirements"] },
      { id: "slice-save-state", label: "save-state", description: "Save slice state after shutdown or agent restart", value: "/slice save-state ", searchAliases: ["save slice state", "slice state snapshot", "slice checkpoint", "preserve slice state"] },
      { id: "slice-backup", label: "backup", description: "Create a recoverable slice state backup", value: "/slice backup ", searchAliases: ["backup slice", "slice backup", "state backup", "recover state", "recover slice state"] },
      { id: "slice-reset-state", label: "reset-state", description: "Reset saved slice state after agents are detached", value: "/slice reset-state ", searchAliases: ["reset slice state", "clear slice state", "discard slice state", "fresh slice state"] },
      ...
      { id: "slice-screen", label: "screen", description: "Open or show the slice screen URL", value: "/slice screen ", searchAliases: ["headed slice", "slice display", "slice browser", "open screen", "show screen"] },
      { id: "slice-auth-import", label: "auth import", description: "Copy this machine's provider credentials into the slice; credentials stay slice-scoped", value: "/slice auth import " },
      { id: "slice-auth-remove", label: "auth remove", description: "Remove slice-local provider credentials and account summary", value: "/slice auth remove " },
      {
        id: "slice-auth-login",
        label: "auth login",
        description: "Start provider login inside the slice for a different account",
        value: "/slice auth login ",
        searchAliases: ["slice account login", "provider account login", "different account", "auth missing", "provider account missing", "provider login missing"],
      },
      { id: "slice-auth-alias", label: "auth alias", description: "Set an Arroba display alias when the provider account label is unclear", value: "/slice auth alias " },
    ],
  },
  {
    id: "workspace",
    ...
    children: [
      ...
      { id: "workspace-link-detach", label: "link detach", description: "Detach the current worktree from a link", value: "/workspace link detach " },
      {
        ...
        label: "sync status",
        description: "Show workspace live sync status and ignore rules",
      ...
      { id: "workspace-sync-targets", label: "sync targets", description: "List workspace live sync targets", value: "/workspace sync targets", searchAliases: ["sync target", "workspace sync target", "synced worktree", "selected worktree", "linked worktree"] },
      ...
      { id: "workspace-sync-audit", label: "sync audit", description: "Show workspace live sync mode audit events", value: "/workspace sync audit", searchAliases: ["sync history", "sync mode history", "mode audit", "live sync audit"] },
      { id: "workspace-sync-off", label: "sync off", description: "Disable live sync for this session; other repositories stay unrestricted", value: "/workspace sync off", searchAliases: ["disable live sync", "turn live sync off", "no live sync", "sync off by default", "other repositories unrestricted"] },
      { id: "workspace-sync-managed", label: "sync managed", description: "Use managed sync for the selected workspace/worktree; other repositories stay unrestricted", value: "/workspace sync managed", searchAliases: ["managed live sync", "managed sync", "managed write fencing", "write fencing", "fenced writes", "provider write fence"] },
      { id: "workspace-sync-tracked", label: "sync tracked", description: "Use tracked sync for the selected workspace/worktree; other repositories stay unrestricted", value: "/workspace sync tracked", searchAliases: ["tracked live sync", "tracked sync", "turn end sync", "turn-end sync", "sync after turn", "without write fencing"] },
      { id: "workspace-sync-default", label: "sync default", description: "Set default live sync for new sessions without changing the current session", value: "/workspace sync default ", searchAliases: ["default live sync", "new session live sync", "sync off by default", "global live sync default"] },
      { id: "workspace-sync-link", label: "sync link", description: "Attach this worktree to a sync link", value: "/workspace sync link ", searchAliases: ["link worktree", "attach worktree", "bind worktree", "sync another repo", "sync target worktree"] },
    ],
  },
  {
    id: "worktree",
      ...
      { id: "config-unset", label: "unset", description: "Unset a dotted config key", value: "/config unset " },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: "managed",
            description: "Default new sessions to managed sync when provider hosts support write fencing",
            value: "/config workspace-live-sync managed",
          },
          {
            id: "config-workspace-live-sync-tracked",
            label: "tracked",
            description: "Default new sessions to tracked turn-end sync; works on workers without managed write fencing",
