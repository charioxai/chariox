...
export const COMMAND_TREE: CommandNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "slice-auth-import", label: "auth import", description: "Import host provider auth into this slice account", value: "/slice auth import " },
      { id: "slice-auth-remove", label: "auth remove", description: "Remove a provider account from this slice", value: "/slice auth remove " },
      { id: "slice-auth-login", label: "auth login", description: "Start login for a slice-specific provider account", value: "/slice auth login " },
      { id: "slice-auth-alias", label: "auth alias", description: "Set or clear a slice provider account alias", value: "/slice auth alias " },
    ],
  },
  {
    id: "workspace",
