...
export const COMMAND_TREE: CommandNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "kernel-debug-bundle", label: "debug-bundle", description: "Export a local session debug bundle", value: "/kernel debug-bundle " },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "workspace-sync-managed", label: "sync managed", description: "Use managed live sync for this session's selected workspace/worktree", value: "/workspace sync managed" },
      { id: "workspace-sync-tracked", label: "sync tracked", description: "Use tracked turn-end live sync for this session's selected workspace/worktree", value: "/workspace sync tracked" },
      ...
      { id: "config-unset", label: "unset", description: "Unset a dotted config key", value: "/config unset " },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: "managed",
            description: "Default new sessions to managed sync for their selected workspace/worktree",
            value: "/config workspace-live-sync managed",
          },
          {
            id: "config-workspace-live-sync-tracked",
            label: "tracked",
            description: "Default new sessions to tracked turn-end sync for their selected workspace/worktree",
