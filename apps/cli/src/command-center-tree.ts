...
export const COMMAND_TREE: CommandNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "workspace-sync-off", label: "sync off", description: "Disable workspace live sync for the current session", value: "/workspace sync off" },
      { id: "workspace-sync-managed", label: "sync managed", description: "Use managed workspace live sync for the current session", value: "/workspace sync managed" },
      { id: "workspace-sync-tracked", label: "sync tracked", description: "Use tracked workspace live sync for the current session", value: "/workspace sync tracked" },
      { id: "workspace-sync-enable-managed", label: "sync enable managed", description: "Enable managed workspace live sync for the current session", value: "/workspace sync enable managed" },
      { id: "workspace-sync-enable-tracked", label: "sync enable tracked", description: "Enable tracked workspace live sync for the current session", value: "/workspace sync enable tracked" },
      { id: "workspace-sync-disable", label: "sync disable", description: "Disable workspace live sync for the current session", value: "/workspace sync disable" },
      {
        id: "workspace-sync-mode",
        label: "sync mode",
        description: "Set current-session workspace live sync mode",
        value: "/workspace sync mode ",
        children: [
          {
            id: "workspace-sync-mode-managed",
            label: "managed",
            description: "Sync current-session Arroba-managed writes with collision checks",
            value: "/workspace sync mode managed",
          },
          {
            id: "workspace-sync-mode-tracked",
            label: "tracked",
            description: "Sync current-session Arroba-turn file changes without write enforcement",
