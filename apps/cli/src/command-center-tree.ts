...
export const COMMAND_TREE: CommandNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "kernel-remote-runtime", label: "remote-runtime", description: "Show provider runs, remote agents, slices, home-proxy, and live sync readiness", value: "/kernel remote-runtime" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "slice-auth-login", label: "auth login", description: "Start provider login inside the slice for a different account", value: "/slice auth login " },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "workspace-sync-managed", label: "sync managed", description: "Use managed live sync with write reservations; requires managed write fencing on the provider host", value: "/workspace sync managed" },
      { id: "workspace-sync-tracked", label: "sync tracked", description: "Use tracked turn-end live sync for this session; works on workers without managed write fencing", value: "/workspace sync tracked" },
