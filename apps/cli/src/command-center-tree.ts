  ...
  },
  {
    ...
    children: [
      ...
      { id: "slice-status", label: "status", description: "Show a slice", value: "/slice status " },
      {
        ...
        value: "/slice doctor ",
        searchAliases: ["slice readiness", "slice provider auth", "slice account", "slice placement", "slice auth missing", "auth missing", "provider login missing"],
      },
      ...
      { id: "slice-auth-remove", label: "auth remove", description: "Remove slice-local provider credentials and account summary", value: "/slice auth remove " },
      {
        ...
        searchAliases: ["slice account login", "provider account login", "different account", "auth missing", "provider login missing"],
      },
