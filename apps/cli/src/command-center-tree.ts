...
export const COMMAND_TREE: CommandNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "extension-sync-status", label: "sync-status", description: "Show home-proxy manifest sync and recovery for an agent", value: "/extension sync-status " },
      { id: "extension-sync-retry", label: "sync-retry", description: "Retry projected home-proxy manifest sync after worker recovery", value: "/extension sync-retry " },
