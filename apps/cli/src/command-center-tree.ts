      ...
      { id: "config-unset", label: "unset", description: "Unset a dotted config key", value: "/config unset " },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: "managed",
            description: "Default new sessions to managed sync for their selected workspace/worktree; other repositories stay unrestricted",
            value: "/config workspace-live-sync managed",
          },
          {
            id: "config-workspace-live-sync-tracked",
            label: "tracked",
            description: "Default new sessions to tracked turn-end sync for their selected workspace/worktree; other repositories stay unrestricted",
