...
export async function handleCloudSlashCommand(
  ...
  deps.flashFooter("usage: /cloud [open|link|status] | /cloud deployments list|show|create|adopt|preflight|release|promote|rollback | /cloud invite create|accept | /cloud members | /cloud collaborators", "error")
}
