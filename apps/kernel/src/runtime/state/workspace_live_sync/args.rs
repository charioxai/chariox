//! Workspace live sync runtime tool argument normalization.

use super::*;

pub(in crate::runtime::state) fn workspace_live_sync_edit_operation_from_args(
    args: crate::transport::runtime_tools::WorkspaceLiveSyncEditArtifactArgs,
...
pub(in crate::runtime::state) fn workspace_live_sync_write_content_from_args(
    operation: &'static str,
    domain: crate::io::ArtifactDomainKind,
    args: &crate::transport::runtime_tools::WorkspaceLiveSyncWriteArtifactArgs,
...
pub(in crate::runtime::state) fn workspace_live_sync_snapshot_id_from_arg(
...
pub(in crate::runtime::state) fn workspace_live_sync_write_snapshot_id_from_arg(
    snapshot_id: Option<String>,
    path: &Path,
) -> Option<crate::io::ArtifactSnapshotId> {
    let snapshot_id = workspace_live_sync_snapshot_id_from_arg(snapshot_id)?;
