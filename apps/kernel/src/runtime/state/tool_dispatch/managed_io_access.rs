use super::managed_io_permission::{
    managed_io_permission_interaction, managed_io_tool_requires_popup,
};
use super::*;

impl KernelRuntimeState {
    pub(super) async fn managed_io_workspace_for_provider_run(
        &self,
    ...
    pub(super) async fn maybe_gate_managed_io_mutation(
        &self,
        session_id: &str,
        agent_id: Option<&str>,
