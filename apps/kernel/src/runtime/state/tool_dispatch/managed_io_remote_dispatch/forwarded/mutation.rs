...
pub(super) fn dispatch_forwarded_apply_patch(
    ...
    let args =
        serde_json::from_value::<crate::transport::runtime_tools::ManagedApplyPatchArgs>(arguments)
...
pub(super) fn dispatch_forwarded_delete(
    ...
    let args =
        serde_json::from_value::<crate::transport::runtime_tools::ManagedDeleteArtifactArgs>(
            arguments,
        )
        .map_err(|error| DaemonError::LocalTransport {
