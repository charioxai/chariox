//! Managed-I/O workspace identity matching, rejection payloads, and git fingerprinting.

use super::*;

pub(in crate::runtime::state) fn add_managed_io_workspace_payload(
...
pub(in crate::runtime::state) fn managed_io_workspace_identity_rejected(
    workspace: &ManagedIoWorkspaceContext,
...
pub(in crate::runtime::state) fn managed_io_workspace_identities_match(
...
pub(in crate::runtime::state) fn managed_io_identity_for_session_workspace_link(
...
pub(in crate::runtime::state) fn normalize_managed_io_repo_url(value: &str) -> String {
    value.trim().trim_end_matches(".git").to_ascii_lowercase()
}

pub(in crate::runtime::state) fn managed_io_is_arroba_source_workspace(root: &PathBuf) -> bool {
