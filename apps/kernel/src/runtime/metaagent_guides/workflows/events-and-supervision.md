...
2. Start or repair the workflow.
3. Stop the turn if there is no immediate decision to make.
4. On wakeup, use `list_events`, `read_event`, `workflow get-run`, and `turn_overview`.
5. Prompt workers only when the run state shows a real need.
