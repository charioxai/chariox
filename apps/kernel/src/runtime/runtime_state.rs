...
impl KernelRuntimeOwnedState {
    ...
    fn workflow_submit_prepared_prompt(
        &self,
        prepared: crate::app::KernelPreparedPromptSubmission,
        workflow_run_id: &str,
        workflow_node_run_id: &str,
    ...
    fn remote_workflow_turn_context_for_prompt(
        &self,
        session_id: &str,
        target_agent_id: &str,
        prompt: &crate::session::PromptQueueItem,
...
fn managed_io_write_content_from_args(
...
fn remote_managed_io_state_from_content(
    path: &PathBuf,
...
fn remote_managed_io_states_content_equal(
...
fn forwarded_workflow_tool_result_should_complete_home_prompt(
    tool_name: &str,
    result: &crate::transport::runtime_tools::RuntimeToolResult,
) -> bool {
    if !result.ok {
...
fn managed_io_read_optional_content(
    workspace_root: &PathBuf,
    path: &PathBuf,
    domain: crate::io::ArtifactDomainKind,
) -> Result<Option<crate::io::ArtifactContent>, DaemonError> {
...
fn managed_io_write_final_content_states(
    workspace_root: &PathBuf,
...
mod managed_io_external_change_notice_tests {
    ...
    fn remote_managed_opaque_move_final_apply_preserves_deleted_source_domain() {
        ...
        let final_apply =
            apply_remote_managed_io_final_states(&root, &initial_states, &final_states)
