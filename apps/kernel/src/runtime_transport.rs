...
use crate::transport::kernel_protocol::{
    ...
    kernel_event_trace_payload, kernel_subscription_scope, map_kernel_error, serialize_frame,
    subscription_event_stream_id, KernelEvent, KernelIncomingFrame, KernelOutgoingFrame,
    KernelSubscriptionScope, KernelTransportError, WAITING_ROOM_INVENTORY_SENTINEL_ID,
