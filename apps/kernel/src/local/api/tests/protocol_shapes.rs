...
fn local_daemon_protocol_terminal_command_catalog_shape_is_versioned() {
    assert_eq!(LOCAL_DAEMON_PROTOCOL_VERSION, 220);
...
fn local_daemon_protocol_workflow_publication_shape_is_versioned() {
    ...
    assert_eq!(
        snapshot.pointer("/0/CreateWorkflowPublication/local_port"),
        Some(&serde_json::json!(3030))
    );
    assert_eq!(
        snapshot.pointer("/6/WorkflowPublicationCreated/publication/local_port"),
        Some(&serde_json::json!(3030))
    );
    assert_eq!(
    ...
    assert_eq!(
        format!("{hash:x}"),
        "f3b26b07ab625c5160314363c25c8408760061aa3f91c5e130620ddfaec2328f"
    );
}
...
fn local_daemon_protocol_session_history_outline_shape_is_versioned() {
    ...
    assert_eq!(
        format!("{hash:x}"),
        "a7e3086587f6968434d61632e45f7f81048b52316b284ec0ad95bef4d5d33c9d"
    );
}
...
fn local_daemon_protocol_active_turn_phase_shape_is_versioned() {
    ...
    assert_eq!(
        format!("{hash:x}"),
        "dd97a59cf8c1c7f097ac3afc92431a16dfb0fdc542530a327f92e98322fc813c"
    );
}
...
fn local_daemon_protocol_terminal_output_shape_is_versioned() {
    ...
    assert_eq!(
        format!("{hash:x}"),
        "c0b482bc4ca6860fa49b3c9a91ea898c64a1a82514dd2e9913c98d10020097ce"
    );
}
