...
pub enum LocalDaemonRequest {
    ...
    AbortAppPackageUpload(AppPackageUploadRequest),
    ListAppInstallations(ListAppInstallationsRequest),
    GetAppInstallation(AppInstallationRequest),
    GetAppInstallationJournal(AppInstallationRequest),
    GetAppWorker(AppWorkerRequest),
    ControlAppWorker(ControlAppWorkerRequest),
    ListAppAutomations(AppWorkerRequest),
    ...
    StartProjectEnvironmentSetup(StartProjectEnvironmentSetupRequest),
    GetProjectEnvironmentSetupStatus(GetProjectEnvironmentSetupStatusRequest),
    CancelProjectEnvironmentSetup(CancelProjectEnvironmentSetupRequest),
    RetryProjectEnvironmentSetup(RetryProjectEnvironmentSetupRequest),
