...
use transcript::{
    ...
    codex_item_id, codex_item_status_is_terminal, decode_codex_output_delta_chunk,
    is_codex_tool_item, normalize_codex_item_type, sync_completed_text_item, sync_tool_item,
...
fn note_assistant_item_completed(turn_tracker: &mut CodexTurnTracker, item: &Value) -> bool {
    let item_type = item
        .get("type")
