...
pub const PASTE_SECRET_TO_COMPUTER_TOOL: &str = "chariox.paste_secret_to_computer";
pub const PASTE_SECRET_TO_COMPUTER_TOOL_ALIAS: &str = "paste_secret_to_computer";
...
pub const SLICE_CLIPBOARD_WRITE_TOOL: &str = "chariox.slice_clipboard_write";
pub const SLICE_CLIPBOARD_WRITE_TOOL_ALIAS: &str = "slice_clipboard_write";
...
pub const SLICE_BROWSER_TAB_TOOL: &str = "chariox.slice_browser_tab";
pub const SLICE_BROWSER_TAB_TOOL_ALIAS: &str = "slice_browser_tab";
pub const SLICE_BROWSER_HISTORY_TOOL: &str = "chariox.slice_browser_history";
pub const SLICE_BROWSER_HISTORY_TOOL_ALIAS: &str = "slice_browser_history";
...
pub const SLICE_BROWSER_EVENTS_TOOL: &str = "chariox.slice_browser_events";
pub const SLICE_BROWSER_EVENTS_TOOL_ALIAS: &str = "slice_browser_events";
pub const SLICE_BROWSER_DOWNLOADS_TOOL: &str = "chariox.slice_browser_downloads";
pub const SLICE_BROWSER_DOWNLOADS_TOOL_ALIAS: &str = "slice_browser_downloads";
pub const SLICE_BROWSER_UPLOAD_TOOL: &str = "chariox.slice_browser_upload";
pub const SLICE_BROWSER_UPLOAD_TOOL_ALIAS: &str = "slice_browser_upload";
pub const SLICE_BROWSER_PERMISSION_TOOL: &str = "chariox.slice_browser_permission";
pub const SLICE_BROWSER_PERMISSION_TOOL_ALIAS: &str = "slice_browser_permission";
