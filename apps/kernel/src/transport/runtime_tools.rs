...
pub const LIST_SESSION_AGENTS_TOOL: &str = "arroba.list_session_agents";
pub const GET_SESSION_AGENT_TOOL: &str = "arroba.get_session_agent";
...
pub const SLICE_BROWSER_DIALOG_TOOL: &str = "arroba.slice_browser_dialog";
