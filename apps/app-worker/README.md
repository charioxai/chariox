...
initial limits require 16 GiB total RAM, 8 GiB currently free RAM, and 32 GiB free
...
repeated builds comparable; they do not establish byte-identical output. CI
still needs immutable builder images/sysroots, a declared Linux glibc baseline,
native compilation on all four targets, and an independent rebuild comparison.
No expensive build workflow is enabled by this change.
