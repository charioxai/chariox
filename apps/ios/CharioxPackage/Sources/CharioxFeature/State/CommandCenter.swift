...
public enum CommandCenterCatalog {
    ...
    private static let rootItems: [CommandCenterItem] = [
        ...
        CommandCenterItem(
            id: "config",
            label: "/config",
            detail: "Inspect and update Chariox user config",
            value: "/config ",
            submitsImmediately: false
        ),
        CommandCenterItem(
    ...
    private static let workspaceItems: [CommandCenterItem] = [
        ...
        CommandCenterItem(
            ...
            detail: "Sync Chariox-managed writes with collision checks",
        ...
        CommandCenterItem(
            ...
            detail: "Sync Chariox-turn file changes without write enforcement",
