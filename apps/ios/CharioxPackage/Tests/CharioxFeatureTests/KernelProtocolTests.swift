...
@Test func createSessionRequestMatchesKernelShape() throws {
    let data = try KernelProtocolCodec.encodeRequestFrame(
        KernelRequestFrame(
            ...
            request: .createSession(
                workspaceID: "/Users/miguel/chariox",
                worktreeID: "/Users/miguel/chariox",
                alias: "ios"
            )
        )
    )
    ...
    #expect(payload["workspace_id"] as? String == "/Users/miguel/chariox")
    #expect(payload["worktree_id"] as? String == "/Users/miguel/chariox")
      ...
      "response": {
        "WorkspaceLiveSyncStatus": {
          "status": {
            ...
            "ignore": {
              "ignore_file": "/repo/.charioxignore",
