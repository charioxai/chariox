...
- the M4.5 refactor is not complete yet: `DaemonApp` still exists as a compatibility facade, and more hot-path ownership must move into real actors/projections before relay scale-out
