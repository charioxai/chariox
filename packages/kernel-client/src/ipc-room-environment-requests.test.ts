...
test("Room Environment state request matches protocol 287", () => {
...
test("Room Environment event replay request matches protocol 287", () => {
  assert.equal(LOCAL_DAEMON_PROTOCOL_VERSION, 287)
...
test("Room Environment Action history request matches protocol 287", () => {
