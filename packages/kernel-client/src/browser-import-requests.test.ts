...
test("import consent serializes only explicit metadata and requires protocol 315", () => {
  ...
  assert.equal(browserImportConsentMinimumProtocolVersion, 315)
  ...
  assert.equal(browserImportSourceMinimumProtocolVersion, 315)
