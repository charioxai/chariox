...
test("import consent serializes only explicit metadata and requires protocol 316", () => {
  ...
  assert.equal(browserImportConsentMinimumProtocolVersion, 316)
  ...
  assert.equal(browserImportSourceMinimumProtocolVersion, 316)
